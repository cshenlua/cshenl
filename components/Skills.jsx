  ...
  return (
    <div className="w-full lg:h-screen p-2">
      <div className="max-w-[1240px] mx-auto flex flex-col justify-center h-full">
        ...
        <h2 className="py-4 text-center">Languages, Frameworks, & Tools</h2>
        ...
        <div className="p-6 shadow-xl rounded-xl">
          <div className="grid grid-flow-row-dense grid-cols-3 justify-center items-center">
            <div className="flex justify-center flex-wrap hover:scale-105 ease-in duration-150">
              <div className="p-1 hover:scale-105 ease-in duration-150">
